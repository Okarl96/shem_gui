...
class HDF5RawStorage:
    ...
    def save_batch(self, data_points: List[DataPoint]):
        ...
        try:
            ...
            raise IOError(f"Failed to save batch to HDF5: {e}")
        
    def save_image(self, image: np.ndarray, name: str = 'reconstructed_image'):
