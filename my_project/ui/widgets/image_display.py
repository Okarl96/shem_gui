...
class ImageDisplayWidget(QWidget):
    ...
    @pyqtSlot(list)
    def show_scan_preview(self, preview_path) -> None:
        ...
        xs, ys = zip(*preview_path, strict=False)
    ...
    def toggle_preview(self, state) -> None:
    ...
    @pyqtSlot(object)
    def update_image(self, image_data) -> None:
