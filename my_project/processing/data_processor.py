...
class DataProcessor(QObject):
    ...
    def __init__(self) -> None:
        ...
        # Storage reference
        self.data_storage: IStorage | None = None
    ...
    def set_storage(self, data_storage: IStorage) -> None:
        """Set reference to data storage."""
        self.data_storage = data_storage

    def set_freshness_window(self, window: float) -> None:
            ...
            for line in lines:
                ...
                if len(parts) == 5:
                    ...
                    for axis, val_str in zip(["X", "Y", "Z", "R"],
                                           [x_str, y_str, z_str, r_str], strict=False):
                        if val_str != "NaN":
